...
void mk_no6hole_710_outside(int m){
	int n=7+1+m;
	
	string s="no-6hole-710-outside-"+to_string(m)+".sat";
	fout.open(s);
	fout<<"c\n";
	fout<<"p cnf 123 0\n"; 
...
int main(){
	mk_no6hole_710_outside(12);
	mk_no6hole_710_outside(14);
	mk_no6hole_710_outside(16);
	mk_no6hole_710_outside(18);
	mk_no6hole_710_outside(19);
	mk_no6hole_710_outside(20);
	mk_no6hole_710_outside(21);
	mk_no6hole_710_outside(22);
} 

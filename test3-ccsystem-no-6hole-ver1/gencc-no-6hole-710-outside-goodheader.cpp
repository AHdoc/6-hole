...
/* known information */
	...
	//if(m==22){ // Symmetric breaking
	//	new_known(idx[8][1][9]); new_known(idx[8][5][9]);
	//	new_known(idx[8][1][10]); new_known(idx[8][5][10]);
	//	new_known(idx[8][1][11]); new_known(idx[2][8][11]);
	//	new_known(idx[8][1][12]); new_known(idx[2][8][12]);
	//}
